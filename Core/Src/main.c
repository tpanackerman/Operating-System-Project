...
OS_Start();
  ...
  while (1)
  {
    ...
    /* 1. Flush USB TX buffer – sau nay TV1 tao task rieng thay the */
    USB_CDC_FlushTX();

    /* 2. Gui Heartbeat moi 1000ms */
    ...
    /* 3. LED nhap nhay – 500ms khi da ket noi PC, 200ms khi chua */
